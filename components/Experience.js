  ...
  const experiences = [
    {
      ...
      bulletPoints: [
        'Streamlined plugin updates supporting 400K+ assets across global analytics deployments.',
        'Extended SPy SDK features for 600+ customers in Seeq Data Lab and Workbench.',
        'Delivered full-stack tools enabling automation via React, TypeScript, Python, Java, and Kotlin.',
      ],
      logo: '/seeq-logo.png',
    },
    {
      ...
      bulletPoints: [
        'Built and maintained a full-stack platform used by 1,100+ Intel Foundry stakeholders.',
        'Shipped updates that boosted engagement by 190% and cut load times by 40%.',
        'Created a real-time dashboard to monitor usage and crash trends across 10+ countries.',
      ],
      logo: '/intel-logo.png',
    },
  ];
